...
//            MetaDomain rootDomain = generateDomainsStructure();
            ...
            /* adding jobs */
            rootDomain.getAssignedJobFlow().jobs.addAll(generateJobFlow(50, 100).jobs);
    ...
    protected MetaDomain generateDomainsStructure() {
        ...
        MetaDomain leafDomain1 = new MetaDomain(1, 0.8, 0.3, 100.1);
        MetaDomain leafDomain2 = new MetaDomain(2, 0.2, 0.9, 100.1);
        MetaDomain leafDomain3 = new MetaDomain(3, 0.7, 0.67, 100.1);
        MetaDomain leafDomain4 = new MetaDomain(4, 0.5, 0.6, 600.1);

        rootDomain.addSubDomain(leafDomain1);
        rootDomain.addSubDomain(leafDomain2);
        rootDomain.addSubDomain(leafDomain3);
        rootDomain.addSubDomain(leafDomain4);
